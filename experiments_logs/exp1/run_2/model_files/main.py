...
# after you read args...
if args.selected_dataset == 'UCR':
    assert args.dataset_name is not None, "Must pass --dataset_name for UCR!"
    data_dir = os.path.join(args.home_path,
                            'data',
                            'UCR',
                            args.dataset_name)
else:
...
#data_dir = os.path.join(args.home_path, 'data', data_type)
home_path = os.getcwd()
# adjust for UCR datasets
if args.selected_dataset == 'UCR':
    assert args.dataset_name is not None, "Must pass --dataset_name for UCR!"
    data_dir = os.path.join(home_path,#args.home_path,
                            'data',
                            'UCR',
                            args.dataset_name)
else:
...
meta = torch.load(os.path.join(data_dir, 'train.pt'))
